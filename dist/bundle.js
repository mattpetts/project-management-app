...
define("state/project-state", ["require", "exports", "models/project", "models/project"], function (require, exports, project_1, project_2) {
    ...
    class ProjectState extends State {
        ...
        addProject(title, description, numOfPeople) {
            const newProject = new project_1.Project(Math.random().toString(), title, description, numOfPeople, project_2.ProjectStatus.ToDo);
...
define("components/project-list", ["require", "exports", "components/base-component", "decorators/autobind", "models/project", "state/project-state", "components/project-item"], function (require, exports, base_component_2, autobind_2, project_js_1, project_state_1, project_item_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_2.Component {
        ...
        dropHandler(event) {
            ...
            let status = project_js_1.ProjectStatus.ToDo;
            if (this.type === 'active') {
                status = project_js_1.ProjectStatus.Active;
            }
            if (this.type === 'qa') {
                status = project_js_1.ProjectStatus.Qa;
            }
            if (this.type === 'finished') {
                status = project_js_1.ProjectStatus.Finished;
            }
            project_state_1.projectState.moveProject(prjId, status);
        }
        configure() {
            ...
            project_state_1.projectState.addListener((projects) => {
                const relevantProjects = projects.filter(prj => {
                    if (this.type === 'todo') {
                        return prj.status === project_js_1.ProjectStatus.ToDo;
                    }
                    else if (this.type === 'active') {
                        return prj.status === project_js_1.ProjectStatus.Active;
                    }
                    else if (this.type === 'qa') {
                        return prj.status === project_js_1.ProjectStatus.Qa;
                    }
                    else {
    ...
    class ProjectInput extends base_component_3.Component {
        ...
        submitHandler(event) {
            ...
            if (Array.isArray(userInput)) {
                ...
                project_state_2.projectState.addProject(title, desc, people);
                this.clearInputs();
            }
        }
    }
...
define("app", ["require", "exports", "components/project-list", "components/project-input"], function (require, exports, project_list_1, project_input_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    new project_list_1.ProjectList('todo');
    new project_list_1.ProjectList('active');
    new project_list_1.ProjectList('qa');
